...
function TaskBoard() {
  ...
  useEffect(() => {
    axios
      .get("https://task-management-backend-ten-flame.vercel.app/tasks")
  ...
  const onDragEnd = async (result) => {
    ...
    await axios.put(
      `https://task-management-backend-ten-flame.vercel.app/tasks/${updatedTask._id}`,
      updatedTask
    );
  ...
  const deleteTask = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        await axios.delete(`https://task-management-backend-ten-flame.vercel.app/tasks/${id}`);
  ...
  const handleUpdateTask = async (e) => {
    e.preventDefault();
    await axios.put(
      `https://task-management-backend-ten-flame.vercel.app/tasks/${editTask._id}`,
      editTask
    );
    setTasks(
